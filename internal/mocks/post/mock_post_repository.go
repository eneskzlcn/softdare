...
func (m *MockPostRepository) IncreasePostCommentCount(arg0 context.Context, arg1 string, arg2 int) (time.Time, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPostRepositoryMockRecorder) IncreasePostCommentCount(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IncreasePostCommentCount", reflect.TypeOf((*MockPostRepository)(nil).IncreasePostCommentCount), arg0, arg1, arg2)
}
